...
def upgrade() -> None:
    ...
    op.add_column('psifos_election', sa.Column('type', sa.Enum('query', 'election', name='electiontypeenum'), nullable=False))
...
def downgrade() -> None:
    ...
    op.add_column('psifos_election', sa.Column('election_type', mysql.ENUM('query', 'election'), nullable=False))
